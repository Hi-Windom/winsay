...
时间过的真快，0.64 是 `2210累计更新` 的最后一个版本啦，转眼间 Sofill- 主题上架也有16天了，让我们相约 ` 2211累计更新` 吧~
...
| 测试平台                        | 兼容性               | 高可用 | 已知问题 |
| ------------------------------- | -------------------- | ------ | -------- |
| siyuan-2.4.8-android for mobile | ❤️❤️❤️❤️💗   | ✔️   |          |
| siyuan-2.4.8-android for pad    | ❤️❤️❤️❤️❤️ | ✔️   |          |
| siyuan-2.4.8-browser            | ❤️❤️❤️❤️❤️ | ✔️   |          |
