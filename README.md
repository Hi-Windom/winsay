...
Sofill-在 0.50 已经支持了绝绝紫（默认）、纯洁蓝、砰砰粉、青葱绿四种明亮模式形态（在右上角点击按钮切换），暗黑模式也即将上线墨绿紫、黑金蓝两个形态，顺利的话大纲样式也会很快上线💥

---

## ✨ 0.56 首发预览暗黑模式墨绿紫形态

Sofill- 0.56 除了试水暗黑模式，同时还引入了标签侧栏样式和虚拟引用样式 ✨

Sofill- 一直致力于“第二默认主题”，0.56 版本上架前，已完成下表的真机测试，enjoy 💫
