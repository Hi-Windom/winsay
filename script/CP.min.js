...
import {
  ...
  ConfirmDialog3,
  ConfirmDialog4,
} from "./module/XML/ConfirmDialog.js";
import * as API from "./utils/api.min.js";
import * as config from "./config.js";


// 记录有用的配置信息，代码压缩后不会出现在生产环境
console.log(`window.siyuan.config.api.token ${window.siyuan.config.api.token}`);
console.log(`window.siyuan.config.system.homeDir ${window.siyuan.config.system.homeDir}`);
console.log(`window.siyuan.config.system.workspaceDir ${window.siyuan.config.system.workspaceDir}`);
console.log(`window.siyuan.config.system.confDir ${window.siyuan.config.system.confDir}`);
console.log(`window.siyuan.config.system.dataDir ${window.siyuan.config.system.dataDir}`);
console.log(`window.siyuan.config.appearance.darkThemes ${window.siyuan.config.appearance.darkThemes}`);
console.log(`window.siyuan.config.appearance.lightThemes ${window.siyuan.config.appearance.lightThemes}`);
console.log(`window.siyuan.config.appearance.mode ${window.siyuan.config.appearance.mode}`);
console.log(`window.siyuan.config.appearance.themeDark ${window.siyuan.config.appearance.themeDark}`);
console.log(`window.siyuan.config.appearance.themeLight ${window.siyuan.config.appearance.themeLight}`);
console.log(`window.siyuan.config.appearance.themeVer ${window.siyuan.config.appearance.themeVer}`);
console.log(`window.siyuan.config.appearance.blockRefTextLeft ${window.siyuan.config.appearance.blockRefTextLeft}`);
console.log(`window.siyuan.config.appearance.blockRefTextRight ${window.siyuan.config.appearance.blockRefTextRight}`);
console.log(`window.siyuan.config.fileTree.maxOpenTabCount ${window.siyuan.config.fileTree.maxOpenTabCount}`);
console.log(`window.siyuan.config.localIPs ${window.siyuan.config.localIPs}`);
console.log(`window.siyuan.config.system.fixedPort ${window.siyuan.config.system.fixedPort}`);
console.log(`window.siyuan.config.appearance.hideStatusBar ${window.siyuan.config.appearance.hideStatusBar}`); // 修改没有效果，仅用于判断
...
checkedChange(
  document.getElementById("SC_winsay_cp_editor__ListAutoIndent"),
  () => {
    document.documentElement.style.setProperty(
